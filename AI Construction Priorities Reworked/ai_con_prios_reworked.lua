...
local modSettings = {enable_Dismantle_Growth = true}

local regions = {
     "wh3_main_combi_region_couronne", "wh3_main_combi_region_miragliano", "wh3_main_combi_region_bordeleaux", "wh3_main_combi_region_lyonesse",
     "wh3_main_combi_region_copher", "wh3_main_combi_region_zandri", "wh3_main_combi_region_castle_carcassonne", "wh3_main_combi_region_castle_artois"
}
...
local function loop_through_list()
     ...
     for i, region_key in pairs(regions) do remove_barracks_add_stables(region_key) end
end
...
core:add_listener("ai_construction_priorities_reworked_mct", "MctInitialized", true, function(context)
     get_mct_settings(context)
     isUsingMCT = true
end, true)

core:add_listener("ai_construction_priorities_reworked_mct_setting_finalized", "MctFinalized", true, function(context) get_mct_settings(context) end, true)
