local regions = {
     ...
     "wh3_main_combi_region_copher", "wh3_main_combi_region_zandri", "wh3_main_combi_region_castle_carcassonne"
}
...
cm:add_first_tick_callback_new(function() initialize_bretonnian_barracks_replacement() end);
