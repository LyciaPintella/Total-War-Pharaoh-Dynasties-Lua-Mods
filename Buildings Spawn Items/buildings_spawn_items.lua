...
local ancillary_master_list = {
     ...
     ["phar_main_all_resource_production_bronze_mine_type_b_1"] = {
          ...
          "z_bodyguard_common_equipment_two_handed_club", "z_bodyguard_common_equipment_two_handed_spear", "z_bodyguard_common_equipment_two_handed_sword"
     },
     ...
     ["phar_main_all_province_management_growth_type_a_3"] = {
          "phar_main_rare_2", "phar_main_rare_6", "phar_sea_rare_8", "phar_main_rare_18", "phar_main_common_armour_medium"
     },
